...
export function ProductDetailClient({
  ...
  const inputCls =
    'block w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-green-700 focus:border-green-700'
