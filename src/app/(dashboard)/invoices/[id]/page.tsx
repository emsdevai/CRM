  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 overflow-hidden">
          ...
          <div className="px-6 py-4 md:border-r border-zinc-100 dark:border-zinc-800">
            ...
            {invoice.customer ? (
              <div className="space-y-1">
                ...
                {(invoice.customer as { city?: string | null; state?: string | null }).city && (
                  <p className="text-sm text-zinc-500">
                    {[
                      (invoice.customer as { city?: string }).city,
                      (invoice.customer as { state?: string }).state,
                    ].filter(Boolean).join(', ')}
                  </p>
                )}
              </div>
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50/20 dark:bg-zinc-800/10">
        ...
        <div className="flex justify-end px-6 py-5 border-t border-zinc-100 dark:border-zinc-800">
          <div className="w-72 text-sm space-y-0 divide-y divide-zinc-100 dark:divide-zinc-800">
            ...
            <div className="flex justify-between py-3.5 bg-zinc-50 dark:bg-zinc-800/60 rounded-lg px-3 -mx-1 mt-2">
              ...
              <span className="font-bold text-2xl text-zinc-900 dark:text-zinc-100">
