      ...
      <td style="padding:8px 10px;border-bottom:1px solid #f0f0f0">
        <div style="display:flex;align-items:center;gap:10px">
          ${(() => {
              ...
              return src
                ? `<img src="${src}" alt="" style="width:60px;height:60px;object-fit:cover;border-radius:6px;border:1px solid #e8e8e8;flex-shrink:0" />`
                : `<div style="width:60px;height:60px;border-radius:6px;background:#f5f5f5;border:1px solid #e8e8e8;flex-shrink:0"></div>`
            })()
          }
          <div>
